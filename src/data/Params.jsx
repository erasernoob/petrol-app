const hydro = [
  {
    fundamental: {
      ...
      Rzz: { name: "钻杆外径 (mm)", value: 127 },
      rzz: { name: "钻杆内径 (mm)", value: 108.6 },
      Lzz: { name: "钻杆长度 (m)", value: 4190 },
...
const limit_mechanism = {
  work_condition: {
    ...
    jsjg: { name: "井深计算间隔 (m)", value: 500 },
    calcCurve: { name: "是否计算屈曲临界载荷 ", value: 1 },
...
const drill_vibration = [
  {
    drill_parameters: {
      ...
      Db: { name: "钻头直径 (mm)", value: 215.9 },
      Lp: { name: "钻杆长度 (m)", value: 5765.26 },
      p1: { name: "钻杆密度 (kg/m³)", value: 8629 },
      Dp: { name: "钻杆外径 (mm)", value: 127 },
      dp: { name: "钻杆内径 (mm)", value: 108.6 },
      Lpw: { name: "加重钻杆长度 (m)", value: 47.26 },
      p3: { name: "加重钻杆密度 (kg/m³)", value: 9058 },
      Dpw: { name: "加重钻杆外径 (mm)", value: 127 },
      dc: { name: "加重钻杆内径 (mm)", value: 57.2 },
      Lc: { name: "钻铤长度 (m)", value: 6.89 },
      p2: { name: "钻铤密度 (kg/m³)", value: 8518 },
      Dc: { name: "钻铤外径 (mm)", value: 171.5 },
      dpw: { name: "钻铤内径 (mm)", value: 76.2 },
    },
  },
  {
    fluid_parameters: {
