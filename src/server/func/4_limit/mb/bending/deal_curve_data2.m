function [Mk,mk,Sk,alphak,phik]=deal_curve_data2(data1,js)
%%  去除井眼轨迹中的重复值，并且按升序排序
...
%     alphas=smooth(alphas,201);
%     phis=smooth(phis,201);
    alphas=smoothdata(alphas, 'gaussian', 20);
    phis=smoothdata(phis, 'gaussian', 20);
